/**
 * PostgreSQL table creation script using native pg
 */
...
const pool = new Pool({
  connectionString: 'postgresql://neondb_owner:npg_Ti8uQUP7NRgA@ep-noisy-field-a5nhpuwg-pooler.us-east-2.aws.neon.tech/neondb?sslmode=require',
  ssl: {
