...
// Clerk API key
const CLERK_SECRET_KEY = 'sk_test_K62Kt1rn96jF7LynnyrnEtSoZJ6GcBVHtFTU2Sffy4';
...
async function setupClerkUsers() {
  try {
    ...
    console.log('Clerk API Key:', CLERK_SECRET_KEY ? `${CLERK_SECRET_KEY.substring(0, 10)}...` : 'Not set');
